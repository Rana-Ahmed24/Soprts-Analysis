...
model = YOLO(r'paddle (3)\models\best (1).pt')  # Use a pre-trained YOLO model or train your own on padel data
...
def process_video(video):
    ...
    try:
        ...
        # Read video
        input_video_path = os.path.abspath(r'paddle (3)\input_videos\input_video.mp4')
        ...
        ball_tracker = BallTracker(model_path=os.path.abspath(r"paddle (3)\models\best (1).pt"))
        ...
        court_model_path = os.path.abspath(r"paddle (3)\models\keypoints_model.pth")
        ...
        for i, frame in enumerate(output_video_frames):
            ...
            # Draw scoreboard on the frame
            frame_with_scoreboard = draw_scoreboard(frame)
            output_video_frames[i] = frame_with_scoreboard
        
        # Save the output video
        output_video_path = os.path.abspath(r'paddle (3)\output_videos\output.mp4')
